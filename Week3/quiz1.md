...
- 답: Working Directory, Repository, Staging Area
...
- 답: 1은 신규 브랜치와 기존 브랜치의 커밋을 모두 포함한 커밋을 생성하고, 2는 신규 브랜치만을 포함한 커밋을 생성하며, 3은 신규 브랜치의 커밋을 그대로 재생성한다.
...
- 답: 가장 최근에 작성된 파일의 commit ID, 작성된 브랜치, 커밋 메세지를 알 수 있다.
